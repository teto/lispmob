...
const char *gengetopt_args_info_help[] = {
  ...
  "  -c, --color=STRING            Enable color  (possible values=\"auto\",\n                                  \"always\", \"never\")",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->color_help = gengetopt_args_info_help[7] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVd:a:Df:c:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'c':	/* Enable color.  */
          ...
          if (update_arg( (void *)&(args_info->color_arg), 
              ...
              &(local_args_info.color_given), optarg, cmdline_parser_color_values, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "color", 'c',
              additional_error))
            goto failure;
