...
#define CMDLINE_PARSER_VERSION "0.3.3"
#endif
...
struct gengetopt_args_info
{
  ...
  char * color_arg;	/**< @brief Enable color.  */
  char * color_orig;	/**< @brief Enable color original value given at command line.  */
  const char *color_help; /**< @brief Enable color help description.  */
